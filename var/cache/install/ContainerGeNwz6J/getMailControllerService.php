...
class getMailControllerService extends Eccube_KernelInstallContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.gxxsrPa'] ?? $container->load('get_ServiceLocator_GxxsrPaService'))->withContext('Eccube\\Controller\\Admin\\Order\\MailController', $container));
