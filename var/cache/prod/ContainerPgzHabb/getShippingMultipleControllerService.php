...
class getShippingMultipleControllerService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator._pehuVM'] ?? $container->load('get_ServiceLocator_PehuVMService'))->withContext('Eccube\\Controller\\ShippingMultipleController', $container));
