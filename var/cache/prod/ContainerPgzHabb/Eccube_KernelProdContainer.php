...
class Eccube_KernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Plugin\\Api42\\Controller\\Admin\\GraphiQLController' => 'getGraphiQLControllerService',
            'Plugin\\Api42\\Controller\\Admin\\OAuthController' => 'getOAuthControllerService',
            'Plugin\\Api42\\Controller\\Admin\\WebHookController' => 'getWebHookControllerService',
            'Plugin\\Api42\\Controller\\ApiController' => 'getApiControllerService',
            'Plugin\\ProductReview42\\Controller\\Admin\\ConfigController' => 'getConfigControllerService',
            'Plugin\\ProductReview42\\Controller\\Admin\\ProductReviewController' => 'getProductReviewControllerService',
            'Plugin\\ProductReview42\\Controller\\ProductReviewController' => 'getProductReviewController2Service',
            ...
            'Plugin\\RelatedProduct42\\Controller\\Admin\\RelatedProductController' => 'getRelatedProductControllerService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app'.\DIRECTORY_SEPARATOR.'Plugin'.\DIRECTORY_SEPARATOR.'Api42'.\DIRECTORY_SEPARATOR.'Service'.\DIRECTORY_SEPARATOR.'WebHookEvents.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app'.\DIRECTORY_SEPARATOR.'Plugin'.\DIRECTORY_SEPARATOR.'Api42'.\DIRECTORY_SEPARATOR.'Service'.\DIRECTORY_SEPARATOR.'WebHookTrigger.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app'.\DIRECTORY_SEPARATOR.'Plugin'.\DIRECTORY_SEPARATOR.'Api42'.\DIRECTORY_SEPARATOR.'Service'.\DIRECTORY_SEPARATOR.'CoreEntityTrigger.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app'.\DIRECTORY_SEPARATOR.'Plugin'.\DIRECTORY_SEPARATOR.'Api42'.\DIRECTORY_SEPARATOR.'Service'.\DIRECTORY_SEPARATOR.'WebHookService.php';
    ...
    protected function get_Container_Private_TwigService()
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).'/app/Plugin/Recommend42/Resource/template'), 'Recommend42');
        $a->addPath((\dirname(__DIR__, 4).'/app/Plugin/RelatedProduct42/Resource/template'), 'RelatedProduct42');
        $a->addPath((\dirname(__DIR__, 4).'/app/Plugin/ProductReview42/Resource/template'), 'ProductReview42');
        $a->addPath((\dirname(__DIR__, 4).'/app/Plugin/Api42/Resource/template'), 'Api42');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory($this->parameters['doctrine.dbal.connection_factory.types']))->createConnection(['driver' => 'pdo_sqlite', 'charset' => $this->getEnv('DATABASE_CHARSET'), 'url' => $this->getEnv('DATABASE_URL'), 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'serverVersion' => $this->getEnv('DATABASE_SERVER_VERSION'), 'defaultTableOptions' => ['charset' => 'utf8mb4', 'collation' => 'utf8mb4_bin']], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'Plugin\\Api42\\Doctrine\\EventSubscriber\\EntityListener' => ['privates', 'Plugin\\Api42\\Doctrine\\EventSubscriber\\EntityListener', 'getEntityListenerService', true],
            ...
            'Plugin\\Api42\\Doctrine\\EventSubscriber\\EntityListener' => '?',
            'doctrine.orm.default_listeners.attach_entity_listeners' => '?',
            'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber' => '?',
            'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber' => '?',
            'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber' => '?',
        ]), [0 => 'Eccube\\Doctrine\\EventSubscriber\\InitSubscriber', 1 => 'Eccube\\Doctrine\\EventSubscriber\\SaveEventSubscriber', 2 => 'Eccube\\Doctrine\\EventSubscriber\\TaxRuleEventSubscriber', 3 => 'Plugin\\Api42\\Doctrine\\EventSubscriber\\EntityListener', 4 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 5 => 'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber', 6 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 7 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners']]), []);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'Plugin\\Api42\\Repository\\WebHookRepository' => ['privates', 'Plugin\\Api42\\Repository\\WebHookRepository', 'getWebHookRepositoryService', false],
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('league.oauth2_server.event.user_resolve', [0 => function () {
            return ($this->privates['Plugin\\Api42\\EventListener\\UserResolveListener'] ?? $this->load('getUserResolveListenerService'));
        }, 1 => 'onUserResolve'], 0);
        ...
        $instance->addListener('league.oauth2_server.event.authorization_request_resolve', [0 => function () {
            return ($this->privates['Plugin\\Api42\\EventListener\\AuthorizationRequestResolveListener'] ?? $this->load('getAuthorizationRequestResolveListenerService'));
        }, 1 => 'onAuthorizationRequestResolve'], 0);
        $instance->addListener('kernel.response', [0 => function () {
            return ($this->privates['Plugin\\Api42\\Service\\WebHookService'] ?? $this->getWebHookServiceService());
        }, 1 => 'fire'], 0);
        $instance->addListener('Product/detail.twig', [0 => function () {
            return ($this->privates['Plugin\\ProductReview42\\ProductReviewEvent'] ?? $this->load('getProductReviewEventService'));
        }, 1 => 'detail'], 0);
        $instance->addListener('@admin/Product/product.twig', [0 => function () {
            return ($this->privates['Plugin\\RelatedProduct42\\RelatedProductEvent'] ?? ($this->privates['Plugin\\RelatedProduct42\\RelatedProductEvent'] = new \Plugin\RelatedProduct42\RelatedProductEvent()));
    ...
    {
        return $this->privates['Plugin\\Api42\\Repository\\WebHookRepository'] = new \Plugin\Api42\Repository\WebHookRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /*
     * Gets the private 'Plugin\Api42\Service\WebHookEvents' shared autowired service.
     *
     * @return \Plugin\Api42\Service\WebHookEvents
     */
    protected function getWebHookEventsService()
    {
        $this->privates['Plugin\\Api42\\Service\\WebHookEvents'] = $instance = new \Plugin\Api42\Service\WebHookEvents();

        $instance->addTrigger(new \Plugin\Api42\Service\CoreEntityTrigger());

        return $instance;
    }

    /*
     * Gets the private 'Plugin\Api42\Service\WebHookService' shared autowired service.
     *
     * @return \Plugin\Api42\Service\WebHookService
     */
    protected function getWebHookServiceService()
    {
        return $this->privates['Plugin\\Api42\\Service\\WebHookService'] = new \Plugin\Api42\Service\WebHookService(($this->services['router'] ?? $this->getRouterService()), ($this->privates['Plugin\\Api42\\Repository\\WebHookRepository'] ?? $this->getWebHookRepositoryService()), ($this->privates['Plugin\\Api42\\Service\\WebHookEvents'] ?? $this->getWebHookEventsService()));
    }
    ...
    protected function getSecurity_Firewall_MapService()
    {
        ...
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.admin' => ($this->privates['.security.request_matcher.C8rL7Sx'] ?? ($this->privates['.security.request_matcher.C8rL7Sx'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/')));
